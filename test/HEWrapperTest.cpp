...
class HEWrapperTest : public ::testing::Test
{
...
protected:
    ...
    virtual ~HEWrapperTest() {}

    SealBfvEnvironment env;
};

TEST_F(HEWrapperTest, SplitBigNumbers)
{
...
TEST_F(HEWrapperTest, JoinSplitNumbers)
{
...
TEST_F(HEWrapperTest, EncryptionRoundTrip)
{
...
TEST_F(HEWrapperTest, SquareInplace)
{
    vector<double> vec {1.0, 2.1, -5.3, 0};
    SealBfvCiphertext bfvCiphertext(vec, env, 100);
...
TEST_F(HEWrapperTest, MultiplyPlain)
{
    vector<double> vec {1.0, 2.1, -5.3, 0};
...
TEST_F(HEWrapperTest, AddPlainInplace)
{
    vector<double> vec {1.0, 2.1, -5.3, 0};
    SealBfvCiphertext bfvCiphertext(vec, env, 100);
